...
public class MainActivity extends AppCompatActivity {
    private static ArrayList<CardData> arrayList;
    CardData cardData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1= (TextView) findViewById(R.id.card_no);
        t2= (TextView) findViewById(R.id.card_exp);
        t3= (TextView) findViewById(R.id.card_type);
        t4= (TextView) findViewById(R.id.card_mode);
        t5= (TextView) findViewById(R.id.card_catagory);
    ...
    public void navigateToBaseActivity(View view) {
        ...
        merchantKey = "gtKFFx";
                //((EditText) findViewById(R.id.editTextMerchantKey)).getText().toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        if (requestCode == PayuConstants.PAYU_REQUEST_CODE) {
            if (data != null) {
                ...
                /*JSONArray jsonarray = new JSONArray("payu_response");
           ...
           /* DatabaseOperations databaseOperations = new DatabaseOperations(MainActivity.this);
            databaseOperations.storeInformation(databaseOperations,map.get("card_no"),map.get("card_exp")
                    ,map.get("card_type"),map.get("card_mode"),map.get("card_category"),map.get("status"),map.get("amount"));*/

          t1.setText(map.get("card_no"));
            t2.setText(map.get("txnid"));
            t3.setText(map.get("card_type"));
            t4.setText(map.get("mode"));
            t5.setText(map.get("cardCategory"));
            t6.setText(map.get("status"));
            t7.setText(map.get("amount"));




            Log.d("a",map.get("card_no"));
           ...
           /* JSONObject obj = null;
            try {
                obj = new JSONObject(data.getStringExtra("payu_response"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
            ...
            for(int i = 0 ; i < obj.length() ; i++){
                try {
                    list.add(obj.getJSONObject(i).getString("id"));
                    Log.d("ab",obj.getJSONObject(i).getString("id"));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }*/
